...
2. Ejecuta migraciones en Supabase (`001_initial_schema.sql`, `002_admin_restaurant_policies.sql`, `003_admin_requests_rpc.sql`, `004_admin_dashboard_rpc.sql` y `005_admin_sections_rpc.sql`).
