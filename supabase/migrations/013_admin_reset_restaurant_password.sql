...
REVOKE ALL ON FUNCTION public.admin_reset_restaurant_password(UUID, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.admin_reset_restaurant_password(UUID, TEXT) TO authenticated;
